...
public class AlgorithmExtrapolationExtendedFunnel extends PredictionAlgorithmReturnsTrajectory {
    ...
    public AlgorithmExtrapolationExtendedFunnel() {
    }
    ...
    private Locations next_Location(Locations data, int date) {
        ...
        Locations result_list_funnel = new Locations();
        ...
        for (Location loc : result_list) {
            LocationWithValue<Double> locFunnel = new LocationWithValue<>(loc, 0.0001);
            result_list_funnel.add(locFunnel);
        }
        return result_list_funnel;
    }
