...
public class AlgorithmSimilarTrajectory extends PredictionAlgorithmReturnsTrajectories {
    ...
    // Constructor
    public AlgorithmSimilarTrajectory(Context c) {
        super(c);
    }
    ...
    public PredictionResultData predict(PredictionUserParameters params, PredictionBaseData data) {
        ...
        Log.e("Context of Algorithm", getContext().toString());
    ...
    private PredictionResultData make_prediction() {
        ...
        // 3. Compute how many points we need in the future
        int pred_traj_length = get_number_of_future_points();

        // 4. Get trajectories of all found indices
        return createResultData( get_trajectories_from_indices(possible_indices, pred_traj_length) );
