...
Die aktuelle Position von Herr Storch wird mittels des GPS-Sensors seines Smartphones ebenfalls in der Visualisierung angezeigt. Damit nähert sich Herr Storch dem Zielgebiet an und trifft schließlich auf den gesuchten Vogel.
\end{displayquote}
...
\ref{VisuelleDarstellungDerVorhersage}, \ref{DatenLadenAusMovebank}, \ref{VisualisierungDerVorhandenenDaten}, \ref{BerechnungDesAufenthaltsraumes}, \ref{VorhersageFuerBestimmtenZeitraum}, \ref{VisualisierungInMapboxBeiOutdoorModus} 
}
\end{requirements}
...
\req{BerechnungDesAufenthaltsraumes}{
 Für einen gegebenen Vogel soll ein wahrscheinlicher Aufenthaltsraum berechnet werden. 
 }{
 Es soll, gegeben ein Vogel, für jeden Punkt in der Umgebung des Vogels eine Vorhersage getroffen werden, mit welcher Wahrscheinlichkeit dieser dort anzutreffen ist. 
 }{
 Treffen am 26.04.2018 
 }{
 \ref{DatenLadenAusMovebank} 
...
\req{VisualisierungInMapboxBeiOutdoorModus}
{
...
\timelineitem{Woche 3}{22.05. - 29.05.}{
	...
	\tabitem Visualisierung von Daten aus der Vergangenheit
		...
		\ref{VisualisierungInMapboxBeiOutdoorModus}
}
