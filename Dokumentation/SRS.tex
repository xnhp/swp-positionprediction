...
\req{BerechnungDesAufenthaltsraumes}{
 ...
 Für einen Vogel und eine \textit{Movebank}-Study soll berechnet werden, wie wahrscheinlich es ist, diesen in einem vom Algorithmus bestimmten Gebiet anzutreffen. 
 }{
 Treffen am 26.04.2018 
 }{
 \ref{DatenLadenAusMovebank} 
