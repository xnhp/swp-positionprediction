...
\textbf{Abhängigkeiten:} R3, R4, R5, R6, R8, R13 \\
...
\textbf{Beschreibung:} Es soll, gegeben ein Vogel, für jeden Punkt in der Umgebung des Vogels eine Vorhersage getroffen werden, mit welcher Wahrscheinlichkeit dieser dort anzutreffen ist. \\
\textbf{Quelle:} Treffen am 26.04.2018 \\
\textbf{Abhängigkeiten:} R4 \\
...
% \textbf{Beschreibung:}  \hl{Die Positionsvorhersage soll in Zonen verschiedener Wahrscheinlichkeit eingeteilt werden.} \\
% \textbf{Quelle:} Treffen am 30.04.2018 \\
% \textbf{Abhängigkeiten:} R6 \\
...
\textbf{Beschreibung:} Der Nutzer soll die Möglichkeit haben, einzustellen für welchen Zeitraum ab dem aktuellen Zeitpunkt die Vorhersage berechnet wird. \\
\textbf{Quelle:} Treffen am 26.04.2018\\
\textbf{Abhängigkeiten:} - \\
...
\textbf{Beschreibung:} Der Nutzer soll über Parameter die Vorhersage justieren können. \\
\textbf{Quelle:} Treffen am 26.04.2018\\
\textbf{Abhängigkeiten:} R4 \\
\\
...
\textbf{Beschreibung:} Die Berechnungen zur Vorhersage der wahrscheinlichen Vogelposition sollen in der App angezeigt werden. \\
\textbf{Quelle:} Treffen am 26.04.2018 \\
\textbf{Abhängigkeiten:} R4 \\


\textbf{R101.)} Kompass \\
\textbf{Funktion:} Es soll ein Kompass angezeigt werden, der zum gesuchten Vogel zeigt. \\
\textbf{Beschreibung:} Eine Visualisierung soll anzeigen, in welcher Richtung ausgehend vom aktuellen Standpunkt der gesuchte Vogel am wahrscheinlichsten anzutreffen ist. \\
\textbf{Quelle:} Treffen am 02.05.2018 \\
\textbf{Abhängigkeiten:} R4 \\


\textbf{R102.)} AktuellePosition \\
\textbf{Funktion:} Es soll die aktuelle Position angezeigt werden. \\
\textbf{Beschreibung:} Eine Visualisierung soll auf der dargestellten Kartenlandschaft anzeigen, wo sich der Nutzer momentan befindet.\\
\textbf{Quelle}: Treffen am 02.04.2018 \\
\textbf{Abhängigkeiten:} R12, R13 \\
...
\textbf{Beschreibung:} Wird ein Vogel ausgewählt, so sollen dessen vorhandene Daten in einem bestimmtem Zeitraum angezeigt werden können.\\
\textbf{Quelle:} Treffen am 26.04.2018 \\
\textbf{Abhängigkeiten:} R4 \\


\textbf{R12.)} VisualisierungInCesiumBeiNormalModus\\
\textbf{Funktion:} Im Normal-Modus sollen die Daten in Cesium visualisiert werden.\\
\textbf{Beschreibung:} Befindet sich die Applikation im Normal-Modus, so sollen die getrackten Positionen und die Vorhersagen mit Cesium visualisiert werden.\\
\textbf{Quelle:} Treffen am 26.04.2018\\
\textbf{Abhängigkeiten:} R4, R5, R6, R8\\


\textbf{R13.)} VisualisierungInMapboxBeiOutdoorModus\\
\textbf{Funktion:} Im Outdoor-Modus sollen die Daten mit Mapbox visualisiert werden.\\
\textbf{Beschreibung:} Befindet sich die Applikation im Outdoor-Modus, so sollen die getrackten Positionen und die Vorhersagen mit Mapbox visualisiert werden.\\
\textbf{Quelle:} Treffen am 30.04.2018\\
\textbf{Abhängigkeiten:} R4, R5, R6, R8\\


\textbf{R14.)} VisualisierungAufOfflineKarten\\
\textbf{Funktion:} Im Outdoor-Modus sollen die Daten auf offline-Karten visualisiert werden.\\
...
\textbf{R110.)} Modi \\
\textbf{Funktion:} Die Applikation soll über einen Normal- und einen Outdoor-Modus verfügen. \\
\textbf{Beschreibung:} Die Applikation soll über zwei Modi bzw. Zustände verfügen mit ähnlichem aber ungleichem User Interface und Funktionalität. \\
\textbf{Quelle:} Treffen am 02.05.\\
\textbf{Abhängigkeiten:} - \\

\textbf{R111.)} WechselDesModus \\
\textbf{Funktion:} Der Nutzer soll zwischen dem Normal- und dem Outdoor-Modus wechseln können. \\
\textbf{Beschreibung:} Der Nutzer soll durch Bedienung des User Interfaces zwischen dem Normal und dem Outdoor-Modus wechseln können. \\
\textbf{Quelle:} Treffen am 02.05 \\
\textbf{Abhängigkeiten:} R110 \\
...
\textbf{Quelle:} Treffen am 30.04.2018 \\
\textbf{Abhängigkeiten:} R3, R4, R5, R6, R8, R16, R17 \\
