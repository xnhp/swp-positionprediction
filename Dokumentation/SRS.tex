...
{\colorbox{orange!30}{Weiterhin ist integriert eine VR-Visualisierung.} }

% The software will be composed of several components to enable various
% management and reporting features with centralised access from different
% clients.
...
\begin{itemize} 
	\item \textbf{App}: Soweit nicht anders angemerkt wird hiermit die zu entwickelnde Android-Applikation bezeichnet.
