...
\paragraph{Outdoor-Modus, Normal-Modus} Die Applikation verfügt über zwei verschiedene Funktionsmodi. 
\begin{itemize}
 \item Normal: Dies beschreibt den Modus, der für die Verwendung der App im Burö gedacht ist. D.h. es gibt eine gute Internetverbindung (z.B. über Wlan), die es ermöglicht, schnell viele Daten herunterzuladen, um diese aufwendiger visualieren zu können. 
 \item Outdoor: Dies beschreibt den Modus, der für die Verwendung der App im Feld gedacht ist. D.h. wir haben eher keine gute bzw. gar keine Internetverbindung. So werden hauptsächlich gespeicherte Daten mit einer weniger aufwendigen Visualisierung dargestellt. 
